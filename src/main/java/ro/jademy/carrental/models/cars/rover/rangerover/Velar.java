...
public class Velar extends Rover {

    public Velar(String vinNumber, String fuelType, String carType, String color,
        ...
        super(vinNumber, "Velar", fuelType, carType, color, transmissionType, engine, mileage, horsePower,
