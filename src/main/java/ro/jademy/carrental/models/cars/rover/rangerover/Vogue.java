...
public class Vogue extends Rover {
    ...
    public Vogue(String vinNumber, String fuelType, String carType, String color,
        ...
        super(vinNumber, "Vogue", fuelType, carType, color, transmissionType, engine, mileage, horsePower,
